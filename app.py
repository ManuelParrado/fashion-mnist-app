...
# Cargar el modelo
model = load_model('/content/drive/MyDrive/Curso 2024-25/Collab/PIA/cuadernos RN/models/fashion_mnist.keras')
...
if uploaded_file is not None:
    ...
    st.write('Prediccón', classes[np.argmax(prediction)])
